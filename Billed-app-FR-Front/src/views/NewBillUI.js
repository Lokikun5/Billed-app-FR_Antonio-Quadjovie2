            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border valideMsg" id="msgErr" data-testid="file" />
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="btn-file" class="btn btn-primary">Envoyer</button>
                </div>
              </div>
            </div>
          </form>
